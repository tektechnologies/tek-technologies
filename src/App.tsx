        ...
        <section className="features">
          ...
          <div className="feature-grid">
            <div className="feature-card">
              ...
              <p>
                Track environmental conditions, nutrient levels, and plant
                health metrics 24/7 with our distributed sensor network.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">🔬</div>
              ...
              <p>
                ...
                Full audit trails and batch traceability.
              </p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">⚡</div>
              ...
              <p>
                Machine learning models identify issues before they impact
                yield. Optimize building cycles and resource allocation.
              </p>
            </div>
          </div>
        </section>
